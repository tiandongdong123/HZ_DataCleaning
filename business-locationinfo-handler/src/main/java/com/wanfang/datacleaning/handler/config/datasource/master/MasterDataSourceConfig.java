package com.wanfang.datacleaning.handler.config.datasource.master;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.wanfang.datacleaning.dao.dao.master", sqlSessionTemplateRef = "masterSqlSessionTemplate")
public class MasterDataSourceConfig {
    ...
    public SqlSessionFactory setSqlSessionFactory(@Qualifier("masterDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:com/wanfang/datacleaning/dao/mapping/master/*Mapper.xml"));
