 ...
 */
@Configuration
@MapperScan(basePackages = "com.wanfang.datacleaning.dao.dao.slave", sqlSessionTemplateRef = "slaveSqlSessionTemplate")
public class SlaveDataSourceConfig {
    ...
    @Bean(name = "slaveBaseSqlSessionFactory")
    ...
    public SqlSessionTemplate setSqlSessionTemplate(@Qualifier("slaveBaseSqlSessionFactory") SqlSessionFactory sqlSessionFactory) throws Exception {
